...
<html lang="fr">
    <head>
        ...
        <title>SOLUPARK - Inscription</title>
        <!-- Favicon-->
                    ...
                    <div class="bg-light rounded-3 py-5 px-4 px-md-5 mb-5">
                        ...
                        <div class="row gx-5 justify-content-center">
                            <div class="col-lg-8 col-xl-6">
                                <form method="post" action="/Solupark/Ajoututilisateur">
                                    <!-- Entrée du Nom -->
                                    <div class="form-floating mb-3">
                                        <input class="form-control" name="nom" type="text" placeholder="Votre Nom" maxlength="40" data-sb-validations="nom valide" />
                                        <label for="nom">Nom</label>
                                    </div>
                                    <!-- Entrée du Prénom -->
                                    <div class="form-floating mb-3">
                                        <input class="form-control" name="prenom" type="text" placeholder="Votre Prénom" data-sb-validations="prénom valide" />
                                    ...
                                    <!-- Entrées des mots de passe-->
                                    <div class="form-floating mb-3">
                                        <input class="form-control" name="mdp" type="password" placeholder="Mot de passe" data-sb-validations="required" />
                                        <label for="mdp">Mot de passe</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" name="mdp2" type="password" placeholder="Confirmer le mot de passe" data-sb-validations="required" />
